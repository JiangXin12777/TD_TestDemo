...
void UDamageHandler_DamageSense::HandleDamage_Implementation(UNinjaCombatDamageManagerComponent* DamageManager, const FGameplayCueParameters& Parameters) const
{
