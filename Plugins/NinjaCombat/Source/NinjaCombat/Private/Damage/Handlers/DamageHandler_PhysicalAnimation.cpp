...
void UDamageHandler_PhysicalAnimation::HandleDamage_Implementation(UNinjaCombatDamageManagerComponent* DamageManager, const FGameplayCueParameters& Parameters) const
{
