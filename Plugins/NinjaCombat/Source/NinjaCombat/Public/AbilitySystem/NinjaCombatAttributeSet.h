...
public:
	...
	/**
	 * Total total max health available to the character.
	 *
	 * <pre>
	...
	/**
	 * Total total max magic available to the character.
	 *
	 * <pre>
	 ...
	 *
	 * This modifier is applied to the base damage. For example a base damage of 100 with a critical
	 * hit multiplier of 1.5 will generate an incoming damage of 150.
	 */
	...
	/**
	 * Chance to block with a weapon, shield or any other means.
	 */
	 ...
	 * For example, a damage of 100 with a 0.2 mitigation results in a damage of 80.
	 */
	 ...
	 * common in Soulslike games when you are blocking, but not necessarily common in an adventure game.
	 */
	 ...
	 *
	 * This is an amount from the owner's max health that gets assigned to to health, that now is
	...
	/**
	 * Current amount of poise for this character.
	 *
	 * If this reaches zero the poise breaks and the character is staggered.
	 */
	...
	/** Maximum poise available to the character. */
	UPROPERTY(BlueprintReadOnly, Category = "Poise and Stagger", ReplicatedUsing = OnRep_MaxPoise)
