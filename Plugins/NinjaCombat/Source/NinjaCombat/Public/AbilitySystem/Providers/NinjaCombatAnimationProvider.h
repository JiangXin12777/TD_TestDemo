...
protected:
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Animation Provider")	
	UAnimMontage* GetAbilityAnimationMontage(const UNinjaCombatGameplayAbility* CombatAbility) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Animation Provider")
	FName GetAbilitySectionName(const UNinjaCombatGameplayAbility* CombatAbility) const;
