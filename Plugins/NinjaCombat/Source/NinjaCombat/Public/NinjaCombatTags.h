...
NINJACOMBAT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Tag_Combat_Data_ComboCounter);
...
NINJACOMBAT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Tag_Combat_Data_PoiseConsumption);
