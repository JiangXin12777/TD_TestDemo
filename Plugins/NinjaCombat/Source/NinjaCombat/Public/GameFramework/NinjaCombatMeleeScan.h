...
public:
	...
	static UNinjaCombatMeleeScan* NewInstance(TSubclassOf<UNinjaCombatMeleeScan> MeleeScanClass, AActor* Owner,
		AActor* Instigator, AActor* Causer, UMeshComponent* ScanMesh, TArray<FName> SocketNames, ECollisionChannel ScanChannel,
		EMeleeScanMode ScanMode, FVector ShapeDimensions = FVector::ZeroVector);
