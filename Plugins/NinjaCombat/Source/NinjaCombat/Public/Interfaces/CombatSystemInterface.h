...
public:
	...
	/**
	 * Provide an Arrow Component on the character that is always pointing forward.
	 * 
	 ...
	 * 
	 * @return
	 *		An Arrow Component that can be used by abilities or other modules to compare
	 *		angles, determine a general input and so on.
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Combat System Interface")
	UArrowComponent* GetCombatForwardReference() const;
	virtual UArrowComponent* GetCombatForwardReference_Implementation() const;
	 ...
	 *		a valid implementation of the CombatComboManagerInterface interface.
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Combat System Interface")
	 ...
	 *		a valid implementation of the CombatDamageManagerInterface interface.
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Combat System Interface")
	 ...
	 *		a valid implementation of the CombatDefenseManagerInterface interface.
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Combat System Interface")
	 ...
	 *		a valid implementation of the CombatMotionWarpingInterface interface.
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Combat System Interface")
	...
	/**
	 * Provides the Motion Manager component.
	 *
	 * @return
	 *		The mandatory Movement Manager Component, which is an Actor Component and also
	 *		a valid implementation of the CombatMovementManagerInterface interface.
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Combat System Interface")
	UActorComponent* GetMovementManagerComponent() const;
	virtual UActorComponent* GetMovementManagerComponent_Implementation() const;
